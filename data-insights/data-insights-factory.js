!function(e){if("object"==typeof exports)module.exports=e();else if("function"==typeof define&&define.amd)define(e);else{var f;"undefined"!=typeof window?f=window:"undefined"!=typeof global?f=global:"undefined"!=typeof self&&(f=self),f.DataInsightsFactory=e()}}(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_dereq_,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.MerchantConfig = void 0;
var order_config_set_1 = _dereq_("./order-config-set");
var log_1 = _dereq_(".././log");
var product_config_set_1 = _dereq_("./product-config-set");
var MerchantConfig = /** @class */ (function () {
    function MerchantConfig(modelJson) {
        var _this = this;
        this.orderConfigSet = [];
        this.productConfigSet = [];
        if (modelJson.orders) {
            try {
                modelJson.orders.forEach(function (orderSet) {
                    _this.orderConfigSet.push(new order_config_set_1.OrderConfigSet(orderSet));
                });
                modelJson.products.forEach(function (productSet) {
                    _this.productConfigSet.push(new product_config_set_1.ProductConfigSet(productSet));
                });
            }
            catch (e) {
...
},{".././log":8,"./order-config-set":2,"./product-config-set":5}],2:[function(_dereq_,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.OrderConfigSet = void 0;
var order_level_config_item_1 = _dereq_("./order-level-config-item");
//replaces OrderConfig for V1->V3
var OrderConfigSet = /** @class */ (function () {
    function OrderConfigSet(modelJson) {
        var _this = this;
        ...
        var keys = Object.keys(modelJson);
        keys.forEach(function (key) {
            if (key !== 'row') {
                var item = new order_level_config_item_1.OrderLevelConfigItem(key, modelJson[key]);
                _this.orderLevelConfigItems.push(item);
            }
        });
    }
    return OrderConfigSet;
}());
exports.OrderConfigSet = OrderConfigSet;

},{"./order-level-config-item":3}],3:[function(_dereq_,module,exports){
"use strict";
...
var selector_config_item_1 = _dereq_("./selector-config-item");
var OrderLevelConfigItem = /** @class */ (function (_super) {
    __extends(OrderLevelConfigItem, _super);
    function OrderLevelConfigItem(name, modelJson) {
        var _this = _super.call(this, name, modelJson) || this;
        //cartID and orderID not currency
        if (name === "cartTotal") {
            _this.isCurrency = true;
        }
        else {
    ...
    return OrderLevelConfigItem;
}(selector_config_item_1.SelectorConfigItem));
exports.OrderLevelConfigItem = OrderLevelConfigItem;

},{"./selector-config-item":6}],4:[function(_dereq_,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
var selector_config_item_1 = _dereq_("./selector-config-item");
var ProductConfigItem = /** @class */ (function (_super) {
    __extends(ProductConfigItem, _super);
    function ProductConfigItem(name, modelJson) {
        return _super.call(this, name, modelJson) || this;
        // TODO 5.0 setup formatting here as done in orderConfig
        // https://jira.prodegehq.com/browse/BTN-1670
        // qty - numeric
        // price - currency
        // link - string.. etc..      
        //then we can get rid of DIFactory magicstrings
        //if (configItem.name === 'qty') {
        //if (configItem.name === 'price')
        //if (configItem.name === 'upc')
    }
    return ProductConfigItem;
}(selector_config_item_1.SelectorConfigItem));
exports.ProductConfigItem = ProductConfigItem;

},{"./selector-config-item":6}],5:[function(_dereq_,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ProductConfigSet = void 0;
var product_config_item_1 = _dereq_("./product-config-item");
var ProductConfigSet = /** @class */ (function () {
    function ProductConfigSet(modelJson) {
        var _this = this;
        ...
        keys.forEach(function (key) {
            if (key !== 'row') {
                var item = new product_config_item_1.ProductConfigItem(key, modelJson[key]);
                _this.productConfigItems.push(item);
            }
        });
    }
...
},{"./product-config-item":4}],6:[function(_dereq_,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.SelectorConfigItem = void 0;
var SelectorConfigItem = /** @class */ (function () {
    function SelectorConfigItem(name, modelJson) {
        this.name = name;
...
var data_insights_result_1 = _dereq_("./results/data-insights-result");
var product_result_1 = _dereq_("./results/product-result");
var merchant_config_1 = _dereq_("./configs/merchant-config");
var string_manipulator_1 = _dereq_("./string-manipulator");
var manipulated_string_1 = _dereq_("../ts/results/manipulated-string");
var log_1 = _dereq_("./log");
var order_result_1 = _dereq_("./results/order-result");
var DataInsightsFactory = /** @class */ (function () {
    function DataInsightsFactory() {
        this.diResult = new data_insights_result_1.DataInsightsResult();
        this.sendDiResult = true;
        this.quantityMaxNumber = 2147483000; //less than int
        this.priceMaxNumber = 2147483000; //less than int
    }
    DataInsightsFactory.prototype.setupEventOnUnloadListener = function (siteData, modelJson, source, clientId, debugging) {
        if (debugging) {
        ...
        try {
            log_1.Log.consoleLog('setupEventOnUnloadListener. siteData ', siteData);
            log_1.Log.consoleLog('setupEventOnUnloadListener. Full modelJson ', modelJson);
            var pageType;
            if (siteData.pages && siteData.pageMatch) {
                var pageKeys = Object.keys(siteData.pages);
            ...
            if (source !== "scriptTesterPopupButton") {
                ...
                window.addEventListener('beforeunload', function (e) {
                    ...
                    self_1.getData(siteData.tab.url, modelJson);
                });
            }
            else {
    ...
    // Main Method
    DataInsightsFactory.prototype.getData = function (url, modelJson) {
        var _this = this;
        try {
            ...
            if (!this.merchantConfig) {
                ...
                var dataInsightResultEvent = new CustomEvent('dataInsightResults', { 'detail': this.diResult });
            ...
            if (this.merchantConfig.emptyCartSelector && document.querySelector(this.merchantConfig.emptyCartSelector)) {
                ...
                var orderCounter_1 = 0;
                var orders = void 0;
                // create orders if we have a config that has order rows (like orderhistory or amazon thankyou)
                // TODO We need to to check all orderConfigSets eventually. https://jira.prodegehq.com/browse/BTN-1672
                if (this.merchantConfig.orderConfigSet[0] &&
                    this.merchantConfig.orderConfigSet[0].orderLevelConfigItemRow) {
                    orders = document.querySelectorAll(this.merchantConfig.orderConfigSet[0].orderLevelConfigItemRow.selector);
                }
                if (orders && orders.length > 0) {
                    // multiple order rows (orderhistory / amazon thankyou)
                    orders.forEach(function (orderElement) {
                        var parentDocument = orderElement;
                        _this.diResult.orders[orderCounter_1] = new order_result_1.OrderResult();
                        _this.getOrders(parentDocument, _this.merchantConfig.orderConfigSet, _this.diResult.orders[orderCounter_1]);
                        _this.getProducts(parentDocument, _this.merchantConfig.productConfigSet, _this.diResult.orders[orderCounter_1]);
                        orderCounter_1++;
                    });
                }
                else {
                    //no order rows, single order (most cart, checkout, thankyou pages)
                    this.diResult.orders[orderCounter_1] = new order_result_1.OrderResult();
                    if (orders && orders.length === 0) {
                        var selector = "";
                        if (this.merchantConfig.orderConfigSet[0].orderLevelConfigItemRow.selector) {
                            selector = this.merchantConfig.orderConfigSet[0].orderLevelConfigItemRow.selector;
                        }
                        this.diResult.orders[orderCounter_1].addErrorItem(" Error: Order row not found. Order Row selector:" + selector + " ");
                    }
                    try {
                        this.getOrders(document.documentElement, this.merchantConfig.orderConfigSet, this.diResult.orders[orderCounter_1]);
                        this.getProducts(document.documentElement, this.merchantConfig.productConfigSet, this.diResult.orders[orderCounter_1]);
                    }
                    catch (ex) {
                        log_1.Log.consoleLog('Error processing single order ', ex);
                    }
                }
                log_1.Log.consoleLog("*DI  Dispatching generalMessage " + this.diResult.generalMessage + " ");
                log_1.Log.consoleLog('*DI  Dispatching runtime message DIFactory Results', this.diResult);
            }
        }
        catch (ex) {
            //errors have no enumerable objects, and thus can't be serialized
    ...
    DataInsightsFactory.prototype.getProducts = function (orderOrDocument, productConfigs, orderResult) {
        var _this = this;
        log_1.Log.consoleLog('orderOrDocument tagname ', orderOrDocument.tagName);
        productConfigs.forEach(function (productConfig) {
            var productRows = orderOrDocument.querySelectorAll(productConfig.productConfigItemRow.selector);
            ...
            productRows.forEach(function (productRow) {
                var rowResult = new product_result_1.ProductResult();
                productConfig.productConfigItems.forEach(function (configItem) {
                    var manipulatedString = _this.getIndividualProductSection(orderOrDocument, productRow, configItem);
    ...
    DataInsightsFactory.prototype.getOrders = function (orderOrDocument, orderConfigSets, orderResult) {
        var _this = this;
        orderConfigSets.forEach(function (orderConfig) {
            orderConfig.orderLevelConfigItems.forEach(function (config) {
                if (config.selector || config.useUrl) {
                    var manipulatedString = _this.getOrderLevelItem(orderOrDocument, config);
                    if (manipulatedString.skipped || manipulatedString.error) {
    ...
    DataInsightsFactory.prototype.getOrderLevelItem = function (orderOrDocument, configItem) {
        // let orderLevelItem;
        // TODO .. should I construct later... with actual value
        var manipulatedString = new manipulated_string_1.ManipulatedString("");
        if ((configItem.selector
            && orderOrDocument.querySelector(configItem.selector))
            || configItem.useUrl) {
            // TODO THIS part should be pulled out into a function that makes it same as products
            if (configItem.attribute) {
                var element = orderOrDocument.querySelector(configItem.selector);
            ...
            manipulatedString = this.checkAndProcessStringManipulation(manipulatedString, configItem);
            if (manipulatedString.error) {
                return this.logMessageAsIssue(manipulatedString, configItem, "" + manipulatedString.error);
            }
            if (configItem.isCurrency) {
                manipulatedString.value = string_manipulator_1.StringManipulator.currencyFormatter(manipulatedString.value);
                if (Number(manipulatedString.value) > this.priceMaxNumber) {
                    manipulatedString.addToError("Currency orderLevelItem exceeded max. " + manipulatedString.value + " exceeded maximum of " + this.priceMaxNumber);
                    manipulatedString.value = undefined;
                }
            }
            else {
                manipulatedString.value = string_manipulator_1.StringManipulator.generalFormatter(manipulatedString.value);
            }
        }
        else {
            if (!configItem.selector) {
                manipulatedString.skipped = "no selector found for : " + name;
            }
            else {
    ...
    DataInsightsFactory.prototype.getIndividualProductSection = function (orderOrDocument, productRow, configItem) {
        var element;
        var item;
        ...
        var manipulatedString = new manipulated_string_1.ManipulatedString(item);
        if (!element) {
            return this.logResultAsIssue(manipulatedString, orderOrDocument, productRow, configItem);
        }
        if (configItem.attribute) {
            try {
                manipulatedString.value = element.getAttribute(configItem.attribute);
            ...
            // this is the standard, normal flow
            manipulatedString.value = string_manipulator_1.StringManipulator.generalFormatter(element.textContent);
            manipulatedString = this.checkAndProcessUseType(manipulatedString, element, configItem);
        }
        manipulatedString = this.checkAndProcessStringManipulation(manipulatedString, configItem);
        if (manipulatedString.error) {
        ...
        item = manipulatedString.value;
        if (configItem.name === 'qty') {
            item = string_manipulator_1.StringManipulator.numericFloatFormatter(item);
            if (item !== -1) {
                if (item > this.quantityMaxNumber) {
                    return this.logMessageAsIssue(manipulatedString, configItem, " Error: Quantity exceeded maximum of " + this.quantityMaxNumber);
                }
            }
            else {
                return this.logResultAsIssue(manipulatedString, orderOrDocument, productRow, configItem);
        ...
        if (configItem.name === 'price') {
            item = string_manipulator_1.StringManipulator.currencyFormatter(item);
            if (item !== -1) {
                if (item > this.priceMaxNumber) {
                    return this.logMessageAsIssue(manipulatedString, configItem, " Error: Price exceeded maximum of " + this.priceMaxNumber);
                }
            }
            else {
                return this.logResultAsIssue(manipulatedString, orderOrDocument, productRow, configItem);
        ...
        if (configItem.name === 'upc') {
            if (item !== -1) {
                ...
                item = string_manipulator_1.StringManipulator.returnNumInt(item);
            }
            else {
                return this.logResultAsIssue(manipulatedString, orderOrDocument, productRow, configItem);
            }
        }
        manipulatedString.value = item;
        return manipulatedString;
    };
    DataInsightsFactory.prototype.errorOrDefault = function (configItem, manipulatedString, errorString) {
        if (configItem.useDefault) {
    ...
    DataInsightsFactory.prototype.checkAndProcessStringManipulation = function (manipulatedString, configItem) {
        if (manipulatedString.value && configItem.manipulator) {
            manipulatedString = string_manipulator_1.StringManipulator.getManipulatedValue(manipulatedString, configItem.manipulator);
        }
        return manipulatedString;
    };
    // tru useType if configured, or if we found nothing with textContent
    DataInsightsFactory.prototype.checkAndProcessUseType = function (manipulatedString, element, configItem) {
    ...
    DataInsightsFactory.prototype.logMessageAsIssue = function (manipulatedString, configItem, msg) {
        try {
    ...
    DataInsightsFactory.prototype.logResultAsIssue = function (manipulatedString, orderOrDocument, productRow, configItem) {
        try {
            var name_1 = configItem.name;
            if (!configItem.selector) {
                var skippedItem = name_1 + " : no selector ";
                manipulatedString.skipped = skippedItem;
            }
            else {
                var errItem = 'Error';
                var orderOrDocumentIsDocument = true;
                var selectorInOrder = null;
                ...
                var selectorInDocument = document.querySelector(configItem.selector);
                var selectorInProductRow = productRow.querySelector(configItem.selector);
                if (!selectorInDocument) {
                    errItem = name_1 + " : nothing found on whole document with selector : " + configItem.selector;
                }
                else if (!orderOrDocumentIsDocument && !selectorInOrder) {
                    errItem = name_1 + " : configItem selector " + configItem.selector + " was found in document, but outside of order. ";
                }
                else if (!selectorInProductRow) {
                    errItem = name_1 + " : configItem selector " + configItem.selector + " was found in document/order, but outside of product row. ";
                }
    ...
    DataInsightsFactory.prototype.getIndividualElementBasedOnDefaultType = function (manipulatedString, element) {
    ...
    return DataInsightsFactory;
}());
exports.DataInsightsFactory = DataInsightsFactory;

},{"../ts/results/manipulated-string":10,"./configs/merchant-config":1,"./log":8,"./results/data-insights-result":9,"./results/order-result":11,"./results/product-result":12,"./string-manipulator":13}],8:[function(_dereq_,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Log = void 0;
var Log = /** @class */ (function () {
    ...
    Log.consoleLog = function (str, object) {
...
var DataInsightsResult = /** @class */ (function () {
    function DataInsightsResult() {
        this.orders = [];
    }
    DataInsightsResult.prototype.addToGeneralMessage = function (message) {
...
var ManipulatedString = /** @class */ (function () {
    function ManipulatedString(value) {
        this.value = value;
    }
    ManipulatedString.prototype.addToError = function (errString) {
        if (this.error) {
...
var OrderResult = /** @class */ (function () {
    function OrderResult() {
        this.products = [];
    }
    OrderResult.prototype.addErrorItem = function (newError) {
    ...
    OrderResult.prototype.addSkippedItem = function (newSkip) {
...
var ProductResult = /** @class */ (function () {
    function ProductResult() {
    }
    ProductResult.prototype.addErrorItem = function (newError) {
        if (newError && !this.errorItems) {
            this.errorItems = [newError];
        }
        else {
    ...
    ProductResult.prototype.addSkippedItem = function (newSkip) {
        if (newSkip && !this.skippedItems) {
            this.skippedItems = [newSkip];
        }
        else {
...
var StringManipulator = /** @class */ (function () {
    ...
    // Used by CartTotal, UPC & Price (All Prices converted to ints)
    StringManipulator.isNumericIntString = function (numericString) {
        return /^\d+$/.test(numericString);
    };
    // Quantity must be handled by floats (because of lbs etc..)
    // Used by Qty
    StringManipulator.returnNumFloat = function (stringWithSymbols) {
        // Removing spaces, dot, commas to put it as a numeric string
        if (!stringWithSymbols) {
            return stringWithSymbols;
        }
    ...
    // Used by Qty
    StringManipulator.isNumericFloatString = function (numericString) {
        return /[0-9.]/g.test(numericString);
    };
    // Used by qty
    StringManipulator.numericFloatFormatter = function (numericString) {
        var formattedString = this.removeHtmlTags(numericString);
        var formattedNumString = this.returnNumFloat(formattedString);
    ...
    StringManipulator.generalFormatter = function (string) {
        // For now just removing HTML tags, but might add more functionality as when needed.
        var stringWithOutHtmlTags = this.removeHtmlTags(string);
        // Removing break lines here and trimming extra spaces at the beginning and end of the string.
        var breakRegex = new RegExp('\\n|\\t', 'g');
        return stringWithOutHtmlTags.replace(breakRegex, '').trim();
    };
    StringManipulator.currencyFormatter = function (currencyString, hasCents) {
        if (hasCents === void 0) { hasCents = true; }
        var formattedString = this.removeHtmlTags(currencyString);
    ...
    // #region Manipulators
    // Entry point for string manipulator calls from factory. 
    StringManipulator.getManipulatedValue = function (manipulatedString, manipulatorConfigs) {
        var _this = this;
        ...
        if (manipulatorConfigs.indexOf('::') > -1) {
            var manipulatorGroups = manipulatorConfigs.split('::');
            manipulatorGroups.forEach(function (individualManipulatorGroup) {
                manipulatedString = _this.processInstructions(manipulatedString, individualManipulatorGroup);
            });
        }
        //single instruction
        else {
    ...
    StringManipulator.processInstructions = function (manipulatedString, manipulatorConfig) {
        if (!manipulatorConfig) {
            manipulatedString.addToError(" Error: String manipulation error: no manipulator for " + manipulatedString.value);
            return manipulatedString;
        }
        var manipulatorSections = manipulatorConfig.split(':');
        // decode 'colon' -> ':'
        manipulatorSections = manipulatorSections.map(function (item) { return item.replace('colon', ':'); });
        if (!manipulatedString.value) {
    ...
    StringManipulator.verifyManipulatorParameters = function (count, manipulatorSections) {
    ...
    StringManipulator.getManipulatedValueFormatDate = function (manipulatedString, manipulatorSections) {
        var formattedString = this.generalFormatter(manipulatedString.value);
    ...
    StringManipulator.getManipulatedValueReplace = function (manipulatedString, manipulatorSections) {
        var parameterError = this.verifyManipulatorParameters(3, manipulatorSections);
        if (parameterError) {
            manipulatedString.error += parameterError;
            return manipulatedString;
        }
        var replacee = manipulatorSections[1];
        var replacer = manipulatorSections[2];
        var regExp = new RegExp(replacee, 'g');
        var replaceWithString = replacer;
        var updatedItem = manipulatedString.value.replace(regExp, replaceWithString);
        manipulatedString.value = updatedItem;
        return manipulatedString;
    };
    StringManipulator.getManipulatedValueSale = function (manipulatedString) {
        ...
        var prices = manipulatedString.value.match(/\$\w+\.[0-9][0-9]/g);
        if (prices.length === 1) {
            manipulatedString.value = prices[0];
            return manipulatedString;
        }
        else {
            var priceValues_1 = prices.map(function (price) {
            ...
            prices.filter(function (price) {
                if (price.replace(/\D/ig, '') === priceValues_1[0]) {
    ...
    StringManipulator.getManipulatedValueSplitByIdentifier = function (manipulatedString, manipulatorSections) {
        var parameterError = this.verifyManipulatorParameters(3, manipulatorSections);
        if (parameterError) {
            manipulatedString.error += parameterError;
            return manipulatedString;
        }
        var splitter = manipulatorSections[1];
        var identifier = manipulatorSections[2];
        if (!identifier) {
            manipulatedString.addToError(' Error: String manipulation error: splitGetByIdentifier missing identifier.');
            return manipulatedString;
        }
        var itemElements = manipulatedString.value.split(splitter);
        var itemIdentifier = identifier;
        var itemIdentifierIndex = itemElements.findIndex(function (element) { return element.includes(itemIdentifier); });
        manipulatedString.value = itemElements[itemIdentifierIndex];
        return manipulatedString;
    };
    StringManipulator.getManipulatedValueSplitByIndex = function (manipulatedString, manipulatorSections) {
        var parameterError = this.verifyManipulatorParameters(3, manipulatorSections);
        if (parameterError) {
            manipulatedString.error += parameterError;
            return manipulatedString;
        ...
        var splitter = manipulatorSections[1];
        var index = +manipulatorSections[2];
        if (!index && index !== 0) {
    ...
    StringManipulator.getManipulatedValueSplitByIndexLast = function (manipulatedString, manipulatorSections) {
...
},{"./log":8,"moment":14}],14:[function(_dereq_,module,exports){
//! moment.js
//! version : 2.29.1
