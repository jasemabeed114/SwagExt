...
var serp_injection_settings_1 = _dereq_("../../serp-injection-settings");
var runtime_message_types_1 = _dereq_("../../enums/runtime-message-types");
var runtime_message_1 = _dereq_("../runtime-message");
var $ = _dereq_("jquery");
var SerpInjector = /** @class */ (function (_super) {
    __extends(SerpInjector, _super);
    function SerpInjector(clientId, extensionRuntimeId, objId) {
        var _this = _super.call(this, extensionRuntimeId) || this;
        _this.merchant_objects = [];
        _this.urls = [];
        _this.clientId = clientId;
        _this.searchObj = serp_injection_settings_1.SerpInjectionSettings.SEARCH_PAGE_INJECTION_SETTINGS[objId];
        if (_this.searchObj) {
            _this.initialize();
        }
        return _this;
    }
    SerpInjector.prototype.initialize = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        $(this.searchObj.pattern).each(function (i, el) {
                            _this.setSearchUsed(el, 'small');
                        });
                        if (this.searchObj.patternBig) {
                            $(this.searchObj.patternBig).each(function (i, el) {
                                _this.setSearchUsed(el, 'big');
                            });
                        }
                        return [4 /*yield*/, this.injectSpan()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    SerpInjector.prototype.setSearchUsed = function (el, injectType) {
        var matchURL = this.searchObj.matchURL ? new RegExp(this.searchObj.matchURL + "([^&]+)") : null;
        if (el.getAttribute('href') && el.getAttribute('href').indexOf('http') == 0 && el.getAttribute('sbSearchUsed') !== 'true') {
            var url = el.getAttribute('href');
            if (url.indexOf('url=http') > 0) {
                url = unescape(url.match(/url=([^&]+)/).pop());
            }
            else if (this.searchObj.matchURL && url.indexOf(this.searchObj.matchURL) > 0) {
                url = unescape(url.match(matchURL).pop());
            }
            el.injectUrl = url;
            el.injectType = injectType;
            this.merchant_objects.push(el);
            this.urls.push(url);
            el.setAttribute("searchUsed" + this.clientId, 'true');
        }
    };
    SerpInjector.prototype.injectSpan = function () {
        return __awaiter(this, void 0, void 0, function () {
            var metas, _a, _b, _i, i, element, meta, div, _c, _d, _e, _f;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        if (!(this.urls.length > 0)) return [3 /*break*/, 6];
                    ...
                    case 2:
                        ...
                        i = _a[_i];
                        element = this.merchant_objects[i];
                        meta = metas[i];
                        if (!meta) return [3 /*break*/, 5];
                        div = $("<div/>").css("display", "table");
                        _d = (_c = div).append;
                        return [4 /*yield*/, this.injectImage(element.injectType)];
                    case 3:
                        _d.apply(_c, [_g.sent()]);
                        _f = (_e = div).append;
                        return [4 /*yield*/, this.injectText(meta, element.injectType)];
                    case 4:
                        _f.apply(_e, [_g.sent()]);
                        $(element).prepend(div);
                        _g.label = 5;
    ...
    SerpInjector.prototype.injectImage = function (injectType) {
        return __awaiter(this, void 0, void 0, function () {
            var img, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _b = (_a = img).attr;
                        _c = ['src'];
                        return [4 /*yield*/, this.getExtensionFilePath("assets/images/serp/inject-" + injectType + "-icon.png")];
                    case 1:
                        _b.apply(_a, _c.concat([_d.sent()]));
                        img.attr('style', 'margin:0; float:left');
                        return [2 /*return*/, img];
                }
            });
        });
    };
    SerpInjector.prototype.injectText = function (meta, injectType) {
        return __awaiter(this, void 0, void 0, function () {
            var cashBackText;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.constructRewardString(meta.reward)];
                    case 1:
                        cashBackText = _a.sent();
                        if (injectType === 'big') {
                            cashBackText = "" + SerpInjector.capitalizeFirstLetter(cashBackText);
                        }
    ...
    SerpInjector.prototype.constructRewardString = function (reward) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SerpInjector.capitalizeFirstLetter = function (str) {
        return str.charAt(0).toUpperCase() + str.slice(1);
    };
    return SerpInjector;
}(injection_base_1.InjectionBase));
exports.SerpInjector = SerpInjector;

},{"../../enums/runtime-message-types":1,"../../serp-injection-settings":5,"../runtime-message":4,"./injection-base":3,"jquery":6}],3:[function(_dereq_,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"../../enums/runtime-message-types":1,"../runtime-message":4}],4:[function(_dereq_,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var SerpInjectionSettings = /** @class */ (function () {
    function SerpInjectionSettings() {
    }
    SerpInjectionSettings.SEARCH_PAGE_INJECTION_SETTINGS = [{
            id: 0,
            ...
            id: 1,
            domain: 'mypoints.com',
            rx: new RegExp('mypoints[.]com/search-and-earn[?](q=|.=.*&q=)'),
            pattern: '#main div.algo a',
            matchURL: 'ru=',
            matchTOP: 'true'
        }, {
            ...
            patternBig: '#b_results li.b_algo, #b_results li, #b_results h2 a, div[class="sb_tlst"] a'
        }, {
            id: 5,
            domain: 'google.com',
            rx: new RegExp('^https?://(?:www.|encrypted.)?google.com/.*' +
                '(?:(?:[&?#]q=)|(?:(?:search|webhp|sclient|hl|output|newwindow|[?]gws_rd=ssl).*[&?#]q=))'),
            pattern: 'h3.r a'
        }];
    return SerpInjectionSettings;
}());
exports.SerpInjectionSettings = SerpInjectionSettings;
