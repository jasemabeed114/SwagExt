...
/**
 * Send message back from client website to extension
 * only send cmp data now
 *
 * @export
 * @class HostMessenger
 * @extends {InjectionBase}
 */
var HostMessenger = /** @class */ (function (_super) {
    __extends(HostMessenger, _super);
    function HostMessenger(extensionRuntimeId) {
        var _this = _super.call(this, extensionRuntimeId) || this;
        _this.initialize();
        return _this;
    }
    HostMessenger.prototype.initialize = function () {
        return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); });
    };
    HostMessenger.prototype.sendDataFromHostToExt = function (data) {
...
exports.HostMessenger = HostMessenger;

},{"../../enums/runtime-message-types":1,"../runtime-message":4,"./injection-base":3}],3:[function(_dereq_,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
